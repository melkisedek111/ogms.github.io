                        ...
                        <form action="" method="post">
                            <div class="card">
                                <div class="card-header" data-background-color="red">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h4 class="title">Subject Assigning</h4>
                                            ...
                                            <div class="form-group label-floating">
                                                    <label class="control-label title">Set School Year</label>
                                                        <select name="schoolyear" class="form-control" required>
                                                            ...
                                                            <?php foreach($Schoolyears as $schoolyears): ?>
                                                            <option value="<?php htmlout($schoolyears['schoolyear']); ?>"><?php htmlout($schoolyears['schoolyear']); ?></option>
                                                            <?php endforeach; ?>
                                                            <?php endif; ?>
                                                        </select>
                                                </div>
                                    ...
                                    <table class="table" id="section_table">
                                        ...
                                        <?php foreach($teacher_details as $teacher_detail): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="radio" name="teacherid" class="radio" value="<?php echo $teacher_detail['id']; ?>" required>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                        <?php else: ?>
                                ...
                                <div class="card-footer text-right">
                                    <input type="submit" name="selectSubject" class="btn btn-success" value="Select Subject">
                                    <input type="submit" name="deselectSubject" class="btn btn-danger" value="Deselect Subject">
                                </div>
                            </div>
                        </form>
                        </div>
