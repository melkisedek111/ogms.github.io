                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="orange">
                                    ...
                                    <h4 class="title">User Student Account List</h4>
                                    <p class="category">Complete list of Student Accounts</p>
                                </div>
                                <div class="card-content">
                                    <table class="table" id="teacherSectionTable">
                                        ...
                                        <?php foreach($userStudents as $userStudent): ?>
                                            <tr>
                                                <td>
                                                <?php htmlout($userStudent['id']); ?>
                                                </td>
                                                <td>
                                                <?php htmlout($userStudent['student_number']); ?>
                                                </td>
                                                <td>
                                                <?php htmlout($userStudent['student_firstname']); ?>
                                                </td>
                                                <td>
                                                <?php htmlout($userStudent['student_middlename']); ?>
                                                </td>
                                                <td>
                                                <?php htmlout($userStudent['student_lastname']); ?>
                                                </td>
                                                <td>
                                                <strong><?php htmlout($userStudent['actualPassword']); ?></strong>
                                                </td>
                                                <td>
                                                    <form action="" method="post">
                                                        <input type="hidden" name="userid" value="<?php htmlout($userStudent['id']); ?>">
                                                        <input type="submit" name="changePassword" class="btn btn-success" value="Change Password">
                                                        <?php if($userStudent['user_status'] == 'Activated'):?>
                                                        <input type="submit" name="Deactivated" class="btn btn-danger" value="Deactivate">
                                                        <?php endif; ?>
                                                        <?php if($userStudent['user_status'] == 'Deactivated'):?>
