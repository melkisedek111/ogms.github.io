                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="orange">
                                    <h4 class="title">Change Password for <strong><?php htmlout($studentFirstname); ?> <?php htmlout(substr($studentMiddlename,0,1)); ?>. <?php htmlout($studentLastname); ?> (<?php htmlout(strtoupper($studentType)); ?>)</strong></h4>
                                ...
                                <div class="card-content">
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="userid" value="<?php htmlout($userid); ?>">
