                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="red">
                                    ...
                                    <h4 class="title">Delete Teachers</h4>
                                        ...
                                        <?php foreach($teacher_details as $teacher_detail): ?>
                                            <tr>
                                                ...
                                                <form action="?deletestudentdetails" method="post">
                                                    <input type="hidden" name="deleteid" value="<?php echo $teacher_detail['id']; ?>">
                                                    <input type="submit" name="deletehtml" class="btn btn-danger" value="Delete" onclick="return confirm('Are you sure to delete this record!');">
                                                </form>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
