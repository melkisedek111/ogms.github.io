                        ...
                        <div class="col-md-7">
                            <div class="card">
                                <div class="card-header" data-background-color="<?php htmlout($sidebardcolor); ?>">
                                    ...
                                    <p class="category">Complete Details of user</p>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card card-profile">
                                                <div class="">
                                                    <a href="#pablo">
                                                        <img class="img img-circle" style="width:250px;height: 250px;" src="student_images/<?php htmlout($studentImage); ?>" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            ...
                                                            <p class="text-left"><strong><?php htmlout($admin_userlevel); ?></strong></p>
                                                            <p class="text-left"><strong><?php htmlout($admin_firstname); ?></strong></p>
                                                            <p class="text-left"><strong><?php htmlout($admin_middlename); ?></strong></p>
                                                            <p class="text-left"><strong><?php htmlout($admin_lastname); ?></strong></p>
                                                            <p class="text-left"><strong><?php htmlout($admin_address); ?></strong></p>
                                                            <p class="text-left"><strong><?php htmlout($admin_email); ?></strong></p>
                                                            <p class="text-left"><strong><?php htmlout($admin_contact); ?></strong></p>
                                                            <div class="text-left">
                                                            <span>
