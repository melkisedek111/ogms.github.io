                            ...
                            <form action="" method="post">
                                <div class="card">
                                    <div class="card-header" data-background-color="orange">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4 class="title">Student Assigning</h4>
                                        ...
                                        <table class="table" id="section_table">
                                            ...
                                            <?php foreach($section_details as $section_detail): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="radio" name="sectionid" class="radio" value="<?php echo $section_detail['id']; ?>" required>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                            <?php else: ?>
                                    ...
                                    <div class="card-footer text-right">
                                        <input type="submit" name="selectStudent" class="btn btn-success" value="Select Student">
                                        <input type="submit" name="deselectStudent" class="btn btn-danger" value="Deselect Student">
                                    </div>
                                </div>
                            </form>
                        </div>
